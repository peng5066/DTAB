...
class StandardROIHeadsPseudoLab(StandardROIHeads):
    ...
    def forward(
        ...
        if self.training and compute_loss:  # apply if training loss
            ...
            # box = proposals[0].proposal_boxes
            # print(box)
            # gt_box = proposals[0].gt_boxes
            # print(gt_box)
    ...
    def _forward_box(
        ...
        if (
            ...
            # Get ROI prediction results based on proposals and predictions
            pred_instances, _ = self.box_predictor.inference(predictions, proposals)
            # import inspect
            # print(inspect.getfile(self.box_predictor.inference))  # Print file path
            # print(inspect.getsource(self.box_predictor.inference))  # Print method source code
            return pred_instances, predictions
    ...
    def label_and_sample_proposals(
        ...
        for proposals_per_image, targets_per_image in zip(proposals, targets):
            ...
            # sampled_idxs: indices of positive and negative sample boxes selected on each image, 512 in total; gt_classes: categories corresponding to indices
