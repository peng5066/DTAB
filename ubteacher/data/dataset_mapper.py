...
class DatasetMapperTwoCropSeparate(DatasetMapper):
    ...
    def __call__(self, dataset_dict):
        ...
        """
        dataset_dict = copy.deepcopy(dataset_dict)  # read image, it will be modified by code below
        ...
        aug_input = T.StandardAugInput(image, sem_seg=sem_seg_gt)  # create an object
        # Pass the input object to the data augmentation function for augmentation operations, returns a transform object that includes transformation steps
        transforms = aug_input.apply_augmentations(self.augmentation)  # weak augmentation
        # By accessing the image and boxes attributes of the input object, we can get the image data and bounding box data after augmentation
        ...
        # self.show_image(dataset_dict_key["image"])
        # self.show_image(dataset_dict["image"])
